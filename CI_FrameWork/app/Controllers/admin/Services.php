...
class  Services extends Controller {
    ...
    {
        $data['data']=$this->services->getServices();
        $data['title']="services";
    ...
    public function add()
    {
        ...
        if ($validation->run()) {
            ...
            return redirect()->to(base_url('admin/services/new'));
        }else{

            $this->services->insert_service($title,$slug,$tags,$description,$body,$project_photo,$alt,$ar_title,$ar_body,$ar_tags,$ar_description);
            $this->session->setFlashdata('success', "Service Inserted Successfully");
    ...
    public function update($id)
    {
		...
		if ($validation->run()) {
			$this->session->setFlashdata('error', $validation->getErrors());
            return redirect()->to(base_url('admin/services/edit/'.$id));
		}else{
