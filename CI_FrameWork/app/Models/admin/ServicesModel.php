...
class ServicesModel extends Model {
    ...
    public function getServices()
    {
        ...
        $query = $this->db->query("select * from services where is_article=0 order by creation_date DESC");
    ...
    public function getArticles()
    {
        ...
        $query = $this->db->query("select * from services where is_article=1 order by creation_date DESC");
    ...
    public function insert_service($title,$slug,$tags,$description,$body,$project_photo,$alt,$ar_title,$ar_body,$ar_tags,$ar_description)
    {
     ...
     public function insert_article($title,$slug,$tags,$description,$body,$project_photo,$alt,$ar_title,$ar_body,$ar_tags,$ar_description)
        {
            ...
            $__date = date('Y-m-d');
            $__time = date('H:i:s');
            $query = $this->db->query("insert into services (title,slug,tags,description,body,image,alt,ar_title,ar_description,ar_tags,ar_body,creation_date,creation_time,modified_date,modified_time,is_article)
                                     values('$title','$slug','$tags','$description','$body','$project_photo','$alt','$ar_title','$ar_description','$ar_tags','$ar_body','$__date','$__time','$__date','$__time',1)");
