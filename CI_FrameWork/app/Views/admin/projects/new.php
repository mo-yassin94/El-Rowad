                    ...
                    <h4><i class="icon fa fa-ban"></i> Error!</h4>';
                                    ...
                                    <div class="col-lg-8 row">
                                            ...
                                            <select class="form-control select2 select2-hidden-accessible" name="category" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                                ...
                                                <?php
                                                	foreach ($sections as $section){
                                                        echo '<option value="'.$section['section_id'].'">'.$section['section_name']
                                                            .'</option>';
                                                    }
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <br>
                                            <input class="form-control" type="text" placeholder="Alt" name="alt">
                                        </div>
                                    ...
                                    <aside class="box box-primary" style="border-top: none">
                                        ...
                                        <input type="hidden" name="section" value="projects" id="section">
                                        <input type="hidden" name="project_photo_src" value="" id="project_photo_src">
                                        <input type="hidden" value="" name="multi_photos" id="hidden_multi_photo">
                                    ...
                                    <div class="col-lg-8 row">
                                            ...
                                            <div class="row" dir="rtl">
                                                ...
                                                <div class="col-xs-6 pull-right">
                                                      <input class="form-control" type="text" placeholder="العنوان" id="title" name="ar_title" required>
                                                    <i class="small"> &nbsp;</i>
                                                </div>
                                            </div>
