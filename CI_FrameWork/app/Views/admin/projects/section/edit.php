<?php
$get=new \App\Models\admin\ProjectsModel();
$data=$get->get_section_by_id($id);
foreach ($data as $row){
	$data['id']=$row['section_id'];
	$data['section_name']=$row['section_name'];
	$data['slug']=$row['section_slug'];
	$data['section_description']=$row['section_description'];
	$data['section_tags']=$row['section_tags'];
	$data['section_ar_tags']=$row['section_ar_tags'];
	$data['section_ar_name']=$row['section_ar_name'];
	$data['section_ar_description']=$row['section_ar_description'];
...
<div class="content-wrapper">
	...
	<section class="content-details">
		<form class="content" action="<?= base_url('admin/projects/sections/update/'.$data['id']);?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-6 pull-left">
                                                        <input class="form-control" type="text" value="<?= $data['section_name']?>" placeholder="Title" id="title" name="title" required>
                                                        <i class="small"> &nbsp;</i>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-6 pull-left">
                                                        <input class="form-control input-sm" type="text" placeholder="Project-slug" value="<?= $data['slug']?>" name="slug" id="slug">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="tab_1">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" rows="3" name="desc" placeholder="Enter ..."><?= $data['section_description']?></textarea>
                                                            </div>
                                                        ...
                                                        <div class="tab-pane" id="tab_2">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" rows="3" name="tags"
                                                                          placeholder="Enter ..."><?= $data['section_tags']?></textarea>
                                                            </div>
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="tab_4">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" rows="3" name="ar_desc" placeholder=" ..."><?= $data['section_ar_description']?></textarea>
                                                            </div>
                                                        ...
                                                        <div class="tab-pane" id="tab_6">
                                                            ...
                                                            <div class="form-group">
                                                                <label>الوسوم :</label>
                                                                <textarea class="form-control" rows="3" name="ar_tags" placeholder=" ..."><?= $data['section_ar_tags']?></textarea>
                                                            </div>
                                                        </div><!-- /.tab-pane -->
                                                    </div><!-- /.tab-content -->
                                                </div><!-- nav-tabs-custom -->
                                            ...
                                            <div class="col-lg-8 row">
                                                ...
                                                <div class="row" dir="rtl">
                                                    ...
                                                    <div class="col-xs-6 pull-right">
                                                        <input class="form-control" type="text" placeholder="العنوان" id="title" value="<?= $data['section_ar_name']?>" name="ar_title" required>
                                                        <i class="small"> &nbsp;</i>
                                                    </div>
                                                </div>
