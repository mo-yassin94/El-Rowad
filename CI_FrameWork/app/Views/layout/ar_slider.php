    <!-- SLIDER START -->
    <div id="welcome_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="goodnews-header" data-source="gallery" style="background:#eeeeee;padding:0px;" dir="ltr">
        <div id="welcome" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.1">
            <ul>
                ...
                <li data-index="rs-901"
                    ...
                    data-thumb="uploads/images/slider/1.webp"
                    data-rotate="0"
                    ...
                    data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="uploads/images/slider/1.webp"  alt="<?= lang('site.title')?>" title="<?= lang('site.title')?>"   data-lazyload="uploads/images/slider/1.webp" data-bgposition="center center"
                    ...
                    <div class="tp-caption tp-shape tp-shapewrapper "
                         ...
                         style="z-index: 1;background-color:rgba(255, 255, 255, 0);border-color:rgba(0, 0, 0, 0);border-width:0px;">
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         data-y="['top','top','top','top']" data-voffset="['240','240','220','220']"
                        ...
                        <div class="white-color txt-shadow">  اختيارك الأمثل للبناء </div>
                    ...
                    <div class="tp-caption rev-btn  tp-resizeme slider-block"
                         ...
                         data-x="['right','right','right','right']" data-hoffset="['0','80','80','60']"
                         data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']"
                         data-width="none"
                         data-height="none"
                         data-whitespace="nowrap"
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         data-x="['right','right','right','right']" data-hoffset="['50','130','130','130']"
                         data-y="['top','top','top','top']" data-voffset="['360','360','350','340']"
                    ...
                    <div class="tp-caption tp-resizeme"
                         ...
                         data-y="['top','top','top','top']" data-voffset="['440','440','500','480']"
                        ...
                        <a href="<?= $lang?>/services" class="site-button-secondry btn-effect">المزيد </a>
                    </div>
                ...
                <li data-index="rs-902"
                    ...
                    data-easeout="default"
                    data-masterspeed="default"
                    data-thumb="uploads/images/slider/2.webp"
                    data-rotate="0"
                    data-fstransition="fade"
                    data-fsmasterspeed="300"
                    data-fsslotamount="7"
                    ...
                    data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="uploads/images/slider/2.webp"  alt="<?= lang('site.title')?>" title="<?= lang('site.title')?>"  data-lazyload="uploads/images/slider/2.webp" data-bgposition="center center"
                         data-bgfit="cover" data-bgparallax="4" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    <!-- LAYER NR. 1 [ for overlay ] -->
                    <div class="tp-caption tp-shape tp-shapewrapper "
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         data-x="['right','right','right','right']" data-hoffset="['50','130','130','130']"
                         data-y="['top','top','top','top']" data-voffset="['240','240','210','210']"
                         data-fontsize="['72','72','62','52']"
                         data-lineheight="['82','82','72','62']"
                         data-width="['700','700','700','90%']"
                         data-height="['none','none','none','none']"
                         ...
                         style="z-index: 13;
                            ...
                            color:#111;
                            border-width:0px;font-family: 'Poppins', sans-serif; text-transform:uppercase ;">
                        <div class="white-color txt-shadow">  حلمك متاح الان </div>
                ...
                <li data-index="rs-903"
                    ...
                    data-easeout="default"
                    data-masterspeed="default"
                    data-thumb="uploads/images/slider/3.webp"
                    data-rotate="0"
                    data-fstransition="fade"
                    data-fsmasterspeed="300"
                    data-fsslotamount="7"
                    ...
                    data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="uploads/images/slider/3.webp"   alt="<?= lang('site.title')?>" title="<?= lang('site.title')?>"  data-lazyload="uploads/images/slider/3.webp" data-bgposition="center center"
                         data-bgfit="cover" data-bgparallax="4" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    <!-- LAYER NR. 1 [ for overlay ] -->
                    <div class="tp-caption tp-shape tp-shapewrapper "
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 13;
                            ...
                            color:#111;
                            border-width:0px;font-family: 'Poppins', sans-serif; text-transform:uppercase ;">
                        <div class="white-color txt-shadow">  معاً نبني المستقبل </div>
