        ...
        <ul>
            ...
            <li data-index="rs-901"
                ...
                <div class="tp-caption   tp-resizeme"
                    ...
                    <div class="white-color txt-shadow">Your Best Choice For Building</div>
                ...
                <div class="tp-caption tp-resizeme"
                    ...
                    <a href="<?= $lang?>/services" class="site-button-secondry btn-effect">More</a>
                </div>
            ...
            <li data-index="rs-902"
                ...
                <div class="tp-caption   tp-resizeme"
                     ...
                     style="z-index: 13;
                            ...
                            color:#111;
                            border-width:0px;font-family: 'Poppins', sans-serif; text-transform:uppercase ;">
                    <div class="white-color txt-shadow">Your Dream Available Now</div>
            ...
            <li data-index="rs-903"
                ...
                <div class="tp-caption   tp-resizeme"
                     ...
                     style="z-index: 13;
                            ...
                            color:#111;
                            border-width:0px;font-family: 'Poppins', sans-serif; text-transform:uppercase ;">
                    <div class="white-color txt-shadow">Together we build the future</div>
