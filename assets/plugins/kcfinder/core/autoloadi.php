...
function __autoload($class) {
    if ($class == "uploader")
        require "components/kcfinder/core/uploader.php";
    elseif ($class == "browser")
        require "components/kcfinder/core/browser.php";
    elseif (file_exists("core/types/$class.php"))
        require "components/kcfinder/core/types/$class.php";
    elseif (file_exists("lib/class_$class.php"))
        require "components/kcfinder/lib/class_$class.php";
    elseif (file_exists("lib/helper_$class.php"))
        require "components/kcfinder/lib/helper_$class.php";
}
